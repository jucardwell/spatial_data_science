...
-   Execute a spatial join between `temp` and `nc_counties`. Drop geometry and aggregate the `temp` object to the county level (take the sum of the `total_obs` and `total_over_70` columns per county).
