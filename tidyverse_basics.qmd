...
**Q4: Write a command that multiplies 5 by 2**
...
**Q5: Write a command that adds 10+7 and checks whether that is greater than 20.**
...
**Q5: Write a command that calculates the max of the following values (1, 92, 57, 12).**
...
**Q6: Create an object called `my_first_object` and assign the string "Hello World" to it. Then print the object.**
...
**Q7: What happens if you values are not the expected data type? For instance, if you wanted to add sample to x?**
